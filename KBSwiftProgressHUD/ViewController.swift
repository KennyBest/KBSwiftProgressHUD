...
class ViewController: UIViewController {
    ...
    var indefiniteAnimationView: KBIndefiniteAnimationView?
...
//    }()
    ...
    @IBAction func clickShowButton(_ sender: Any) {
        self.indefiniteAnimationView = KBIndefiniteAnimationView(frame: CGRect(x: self.view.center.x - 50, y: self.view.center.y - 50, width: 100, height: 100))
...
//        self.indefiniteAnimationView?.isHidden = true
